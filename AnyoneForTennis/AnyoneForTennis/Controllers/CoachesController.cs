...
namespace AnyoneForTennis.Controllers
{
    public class CoachesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CoachId,Name,Age,Biography,Username")] Coach coach)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CoachId,Name,Age,Biography,Username")] Coach coach)
        {
            if (id != coach.CoachId)
            {
                return NotFound();
